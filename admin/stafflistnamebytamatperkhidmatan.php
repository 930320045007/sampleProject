...
<?php $menu3='11';?> 
<?php
$sql_where = " login.login_status = '0'";
	...
	<div>
        ...
        <div class="tabbox">
            ...
            <?php if(checkUserSysAcc($row_user['user_stafid'], $menu, $menu2, 1)){?>
              ...
              <li>
                <div class="note">Senarai nama kakitangan Tamat Perkhidmatan</div>
                ...
                <?php if ($totalRows_staf > 0) { // Show if recordset not empty ?>
                  ...
                  <tr class="on">
                    ...
                    <td align="left" valign="middle" class="txt_line"><div><strong class="in_upper"><a href="edit.php?id=<?php echo $row_staf['user_id']; ?>"><?php echo getFullNameByStafID($row_staf['user_stafid']); ?> &nbsp; ( <?php echo $row_staf['user_stafid']; ?> )</a></strong></div></td>
