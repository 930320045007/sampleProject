                ...
                <div>
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr class="on">
					  ...
					  <div>
					    <blockquote>
					      <p><?php echo getFullNameByStafID($row_staf['user_stafid'],1) . " (" . $row_staf['user_stafid'] . ")";?></p>
					      </blockquote>
					  </div>
                      </td>
                      <?php for($mc=1; $mc<13; $mc++){?>
                      <?php if($mc<10) $mc = '0' . $mc;?>
                      <td align="center" valign="middle" nowrap="nowrap" <?php if(countLeaveTypeByStafID($row_staf['user_stafid'], '2', $mc, '2018')=='0') echo "class=\"txt_color1\"";?>><?php echo countLeaveTypeByStafID($row_staf['user_stafid'], '2', $mc, '2018');?></td>
                      <?php }; ?>
                      <td align="center" valign="middle" nowrap="nowrap"><?php echo countLeaveTypeByStafID($row_staf['user_stafid'], '2', '0', '2018');?></td>
                    </tr>
