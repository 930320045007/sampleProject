                ...
                <div>
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr class="on">
                      ...
                      <td align="left" valign="middle" nowrap="nowrap"><a href="<?php echo $url_main;?>admin/salary.php?id=<?php echo getID($row_staf['user_stafid'],1);?>&amp;bulan=<?php echo $m . "/" . $y;?>"><?php echo getFullNameByStafID($row_staf['user_stafid'],1); ?></a></td>
