...
$query_allleave = "SELECT userleavedate_id, userleavedate_note, clinictype_id FROM www.user_leavedate WHERE user_stafid = '" . $userid . "' AND userleavedate_date_y = '" . $y . "' AND (leavetype_id = '1' OR leavetype_id = '2' OR leavetype_id = '4' OR leavetype_id = '5' OR leavetype_id = '6' OR leavetype_id = '7' OR leavetype_id = '11') AND userleavedate_status = '1' AND userleavedate_app < '2' ORDER BY userleavedate_date_y ASC, userleavedate_date_m ASC, userleavedate_date_d ASC";
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tabinfo">
                  ...
                  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tabborder">
                    ...
                    <tr class="back_lightgrey">
                      ...
                      <td align="center" valign="middle" class="line_t"> <?php $ddCuti = getLeave($userid, $y)+ getTotalLeaveGanti($userid, $y) + countPLC2year($userid, $y) + getTotalLeaveKhasPerubatan($userid, $y);?>
                    ...
                    <tr class="on">
                      ...
                      <td nowrap="nowrap" class="line_t"><?php echo shortText($row_allleave['userleavedate_note'], 40);?></td>
