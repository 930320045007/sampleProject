        ...
        <div class="tabbox">
          <div class="profilemenu">
            ...
            <?php if(checkUserSysAcc($row_user['user_stafid'], $menu, $menu2, 2)){?>
                <li class="form_back">
                  <form id="form1" name="form1" method="get" action="../admin/stafleaveadmin.php">
              ...
              <tr class="on">
                        ...
                        <div><strong><a href="<?php echo $url_main;?>admin/stafleaveindv.php?id=<?php echo $row_ul['user_stafid'];?>&dmy=<?php echo $dm . "/" . $dy;?>"><?php echo getFullNameByStafID($row_ul['user_stafid']) . " (" . $row_ul['user_stafid'] . ")"; ?></a></strong></div>
