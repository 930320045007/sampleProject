    ...
    <td nowrap="nowrap" class="line_b line_r"><strong>C. JUMLAH POTONGAN</strong></td>
             ...
             <tr>
              ...
              <tr>
               ...
               <td>
				<?php if(getTransactionIDByUserID($userpcb)=='49' || '66') {?>
                 <?php for($i=1; $i<=12; $i++){ if($i<10) $i = '0' . $i;?>
                <?php $transid += getTransactionPCBByUserID($userpcb,49,1, $i, $y);?> <?php }; ?><strong><?php echo number_format($transid,2);?></strong>
                 <?php } else {?>
                 <strong>0.00</strong>
                 <?php };?>
              </tr>
      ...
      <td align="left">
       <table width="100%" border="0" cellspacing="0" cellpadding="0" class="box2">
          <tr>
            ...
            <td class="noline in_upper" nowrap="nowrap"><strong><?php echo getFullNameByStafID(getKetuaUnitByDirID(10));?></strong></td>
          </tr>
          <tr>
            <td nowrap="nowrap">Jawatan</td>
            <td class="noline in_upper" nowrap="nowrap"><strong><?php echo getJobtitle(getKetuaUnitByDirID(10));?><br /><?php echo getDirSubName(10);?></strong></td>
           </tr>
           <tr>
            <td nowrap="nowrap">Nama dan Alamat Majikan</td>
            <td class="noline in_upper" nowrap="nowrap"><strong>INSTITUT SUKAN NEGARA MALAYSIA<br />KOMPLEKS SUKAN NEGARA<br />P.O BOX 10440, 50714 K.LUMPUR</strong></td>
           </tr>
            </table>
            </td>
      </tr>
