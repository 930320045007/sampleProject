                ...
                <div class="off2">
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr class="on">
                      ...
                      <td align="center" valign="middle" nowrap="nowrap"><?php echo number_format(getPERKESOStafRM($row_staf['user_stafid'], $d, $m, $y), 2);?></td>

                      <td align="center" valign="middle" nowrap="nowrap"><?php echo number_format(getPERKESOEmpRM($row_staf['user_stafid'], $d, $m, $y), 2);?></td>
