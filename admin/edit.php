...
//echo '<pre>'; print_r($query_userprofile) . '</pre>'; # papar sql
...
mysql_select_db($database_hrmsdb, $hrmsdb);
$query_tg2 = sprintf("SELECT * FROM www.user_salaryskill WHERE user_stafid = %s AND usersalaryskill_status = 1 ORDER BY usersalaryskill_date_y DESC, usersalaryskill_date_m DESC, usersalaryskill_date_d DESC, usersalaryskill_id DESC", GetSQLValueString($colname_userprofile, "text"));
$tg2 = mysql_query($query_tg2, $hrmsdb) or die(mysql_error());
$row_tg2 = mysql_fetch_assoc($tg2);
$totalRows_tg2 = mysql_num_rows($tg2);
mysql_select_db($database_hrmsdb, $hrmsdb);
            ...
            <ul>
              ...
              <div id="formprofile" class="hidden">
                <li>
                      ...
                      <div id="formLantikan" class="hidden">
                        <li>
                          <form id="formDateLantikan" name="formDateLantikan" method="post" action="../sb/update_tarikhlantikan.php">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td class="label">Tarikh Mula <br /> Dilantik Ke MSN</td>
                                <td>
                              ...
                              <tr>
                                <td class="label">Tarikh Mula Lantikan<br /> Tetap</td>
                                <td>
                              ...
                              <tr>
                                <td class="label">Tarikh Mula <br /> Kontrak/Pinjaman</td>
                                <td>
                                  <select name="userjob_kontrak_start_d" id="userjob_kontrak_start_d">
                                    <option value="-" selected="selected">--Sila Pilih--</option>
                                    <?php for($i=1; $i<=31; $i++){ if($i<10) $i = '0' . $i;?>
                                    <option <?php if($row_userjobdate['userjob_kontrak_start_d']==$i) echo "selected=\"selected\"";?> value="<?php echo $i;?>"><?php echo $i;?></option>
                                    <?php }; ?>
                                  </select>
                                  <select name="userjob_kontrak_start_m" id="userjob_kontrak_start_m">
                                    <option value="-" selected="selected">--Sila Pilih--</option>
                                    <?php for($j=1; $j<=12; $j++){ if($j<10) $j = '0' . $j;?>
                                    <option <?php if($row_userjobdate['userjob_kontrak_start_m']==$j) echo "selected=\"selected\"";?> value="<?php echo $j;?>"><?php echo date('M', mktime(0, 0, 0, $j, 1, date('Y')));?></option>
                                    <?php }; ?>
                                  </select>
                                  <select name="userjob_kontrak_start_y" id="userjob_kontrak_start_y">
                                    <option value="-" selected="selected">--Sila Pilih--</option>
                                    <?php for($k=(date('Y')-60); $k<=(date('Y')+5); $k++){?>
                                    <option <?php if($row_userjobdate['userjob_kontrak_start_y']==$k) echo "selected=\"selected\"";?> value="<?php echo $k;?>"><?php echo $k;?></option>
                                    <?php }; ?>
                                  </select>
                                </td>
                              </tr>
                              ...
                              <tr>
                                <td class="label">Tarikh Tamat <br /> Kontrak/Pinjaman</td>
                                <td>
                                  <select name="userjob_kontrak_end_d" id="userjob_kontrak_end_d">
                                    <option value="-" selected="selected">--Sila Pilih--</option>
                                    <?php for($i=1; $i<=31; $i++){ if($i<10) $i = '0' . $i;?>
                                    <option <?php if($row_userjobdate['userjob_kontrak_end_d']==$i) echo "selected=\"selected\"";?> value="<?php echo $i;?>"><?php echo $i;?></option>
                                    <?php }; ?>
                                  </select>
                                  <select name="userjob_kontrak_end_m" id="userjob_kontrak_end_m">
                                    <option value="-" selected="selected">--Sila Pilih--</option>
                                    <?php for($j=1; $j<=12; $j++){ if($j<10) $j = '0' . $j;?>
                                    <option <?php if($row_userjobdate['userjob_kontrak_end_m']==$j) echo "selected=\"selected\"";?> value="<?php echo $j;?>"><?php echo date('M', mktime(0, 0, 0, $j, 1, date('Y')));?></option>
                                    <?php }; ?>
                                  </select>
                                  <select name="userjob_kontrak_end_y" id="userjob_kontrak_end_y">
                                    <option value="-" selected="selected">--Sila Pilih--</option>
                                    <?php for($k=(date('Y')-60); $k<=(date('Y')+5); $k++){?>
                                    <option <?php if($row_userjobdate['userjob_kontrak_end_y']==$k) echo "selected=\"selected\"";?> value="<?php echo $k;?>"><?php echo $k;?></option>
                                    <?php }; ?>
                                  </select>
                                </td>
                              </tr>
                              ...
                              <tr>
                                ...
                                <td>
                                  ...
                                  <select name="userjob_tpg_note" id="userjob_tpg_note">
                                    ...
                                    <option value="Kenaikan Gaji Tahunan">Kenaikan Gaji Tahunan</option>
                      ...
                      <div id="viewLantikan">
                        ...
                        <li>
                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                              <td nowrap="nowrap" class="label">Tarikh Mula <br> Kontrak/Pinjaman</td>
                              <td><?php echo $row_userjobdate['userjob_kontrak_start_d']; ?>/<?php echo $row_userjobdate['userjob_kontrak_start_m']; ?>/<?php echo $row_userjobdate['userjob_kontrak_start_y']; ?></td>
                            </tr>
                            <tr>
                              <td nowrap="nowrap" class="label">Tarikh Tamat <br> Kontrak/Pinjaman</td>
                              <td><?php echo $row_userjobdate['userjob_kontrak_end_d']; ?>/<?php echo $row_userjobdate['userjob_kontrak_end_m']; ?>/<?php echo $row_userjobdate['userjob_kontrak_end_y']; ?></td>
                            </tr>
                            <tr>
                          ...
                          <form id="formdgn" name="formdgn" method="POST" action="<?php echo $url_main;?>sb/profile_admin.php?id=<?php echo $colname_userprofile;?>&url=edit">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                ...
                                <td>
                                  <select name="jobtype_id" id="jobtype_id" onchange="dochange('28', 'userdesignation_period', this.value, '0');">
                                    <?php
                                                    do {
                                    ?>
                              ...
                              <tr>
                                ...
                                <td id="userdesignation_period">
                                  <input name="userdesignation_period" type="text" class="w10 txt_right" id="userdesignation_period" value="12" /><span class="inputlabel"> bulan</span><div class="inputlabel2">Isi 0 jika Tetap</div>
                                </td>
                              </tr>
                              <tr>
                          ...
                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <div id="formpen" class="hidden">
                              <li>
                                ...
                                <li>
                                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr class="<?php if($row_userunit['userunit_status']=='1') echo "on"; else echo "offcourses";?>">
                                      ...
                                      <td><ul class="func">
                                        <li><a onClick="return confirm('Anda mahu maklumat berikut dipadam? \r\n\n <?php echo $row_userunit['userunit_in_d']; ?>/<?php echo $row_userunit['userunit_in_m']; ?>/<?php echo $row_userunit['userunit_in_y']; ?> - <?php echo getFulldirectory($row_userunit['dir_id']); ?>')" href="../sb/del_userunitadmindel.php?deleteunit=<?php echo $row_userunit['userunit_id']; ?>&amp;id=<?php echo getID($row_userunit['user_stafid']); ?>">Padam</a></li></ul>
                                      </td>
                                    </tr>
                                      ...
                                      <tr>
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                            ...
                                            <input name="usersalaryskill_basicsalary" type="text" class="w50" onchange="CommaFormatted()" id="usersalaryskill_basicsalary" />
                                          </span></td>
                                        </tr>
                                        <tr>
                                ...
                                <!-- ini edit -->
                                <div id="formtg1" class="hidden">
                                  <li>
                                    <form id="formsalary" name="formsalary" value="<?php echo $row_tgupdate['usersalaryskill_id'] ?>" method="post" action="<?php echo $url_main;?>sb/profile_admin.php?id=<?php echo $colname_userprofile;?>&url=edit">
                                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                          <td class="label">Rujukan Kew 8</td>
                                          <td>
                                            <select name="userkewe_id" id="userkewe_id" value="<?php echo $row_tgupdate['usersalaryskill_id'] ?>" selected>
                                              <option value="0">Tiada</option>
                                              <?php
                                              do {
                                              ?>
                                        ...
                                        <tr>
                                          <td class="label">Tarikh <?php echo $row_tgupdate['usersalaryskill_date_m'] ?></td>
                                          <td><select name="usersalaryskill_date_d" id="usersalaryskill_date_d" value="<?php echo $row_tgupdate['usersalaryskill_date_d'] ?>" selected>
                                            <?php for($i=1; $i<=31; $i++){?>
                                            <option <?php if($i==date('d')) echo "selected=\"selected\"";?> value="<?php if($i<10) $i = '0' . $i; echo $i;?>"><?php echo $i;?></option>
                                            <?php }; ?>
                                          </select>
                                          <span class="inputlabel">/</span>
                                          <select name="usersalaryskill_date_m" id="usersalaryskill_date_m" value="<?php echo $row_tgupdate['usersalaryskill_date_m'] ?>" selected>
                                            <?php for($j=1; $j<=12; $j++){?>
                                            <option <?php if($j==date('m')) echo "selected=\"selected\"";?> value="<?php if($j<10) $j = '0' . $j; echo $j;?>"><?php echo date("m F", mktime(0, 0, 0, $j, 1, 2000));?></option>
                                            <?php }; ?>
                                          </select>
                                          <span class="inputlabel">/</span>
                                          <input name="usersalaryskill_date_y" type="text" class="w10" id="usersalaryskill_date_y" value="<?php echo $row_tgupdate['usersalaryskill_date_y'] ?>" size="4" />
                                        </td>
                                      </tr>
                                      <tr>
                                        <td class="label">Tangga Gaji Baru</td>
                                        ...
                                        <tr>
                                          <td class="noline"><input name="user_stafid" type="hidden" id="user_stafid" value="<?php echo $row_userprofile['user_stafid']; ?>" />
                                          <span class="label noline">
                                            <input name="MM_update_tg" type="hidden" id="MM_update_tg" value="formtg1" />
                                          </span></td>
                                          <td class="noline"><input name="button9" type="submit" class="submitbutton" id="button9" value="Kemaskini" />
                                          <input name="button10" type="button" class="cancelbutton" id="button10" value="Batal"  onclick="toggleview2('formtg1'); return false;"/></td>
                                        </tr>
                                      </table>
                                    </form>
                                  </li>
                                ...
                                <?php }; ?>
                                <div id="viewSalary" name="viewSalary">
                                <li>
                                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <?php do { if($row_tg['usersalaryskill_status']=='1') { ?>
                                    <tr class="<?php if($row_tg['usersalaryskill_status']=='1') echo "on"; else echo "offcourses";?>">
                                      ...
                                      <!-- <td><ul class="func"><li><a onclick="toggleview3('formtg1', '<?php echo $row_tg['usersalaryskill_id'] ?>'); return false;" >Edit</a></li></ul></td> -->
                                      <td align="left"><?php if($row_tg['usersalaryskill_status']=='1') {?>
                                        <ul class="func">
                                        <li><span class="add" onClick="toggleview3('formtg1', '<?php echo $row_tg['usersalaryskill_id'] ?>', '<?php echo $row_tg['user_staffid'] ?>'); return false; ">Edit</span></li></ul>
                                      <?php }; ?>
                                    ...
                                    <tr>
                                      <td colspan="4" align="center" valign="middle" class="txt_color1 noline"><?php echo $totalRows_tg2 ?>  rekod dijumpai</td>
                                    </tr>
                                    <?php } else { ?>
                                    <tr>
                                      <td colspan="4" align="center" valign="middle" class="noline">Tiada rekod dijumpai</td>
                                    ...
                                    <form id="formeml" name="formeml" method="post" action="<?php echo $url_main;?>sb/profile_admin.php?id=<?php echo $colname_userprofile;?>&url=edit">
                                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr>
                                          ...
                                          <td class="label">EL Sewa Rumah</td>
                                          <td><span class="inputlabel">RM</span><span id="sprytextfield21">
                                          <input name="useremolumen_elbhs" type="text" class="w50" id="textfield14" />
                                          <span class="textfieldInvalidFormatMsg">Invalid format.</span></span></td>
                                        </tr>
                                        <tr>
                                          <td class="label">PERWIL</td>
                                          <td colspan="inputlabel"><span class="inputlabel">RM</span><span id="el_o">
                                          <input name="useremolumen_o" type="text" class="w50" id="useremolumen_o" />
                                          <span class="textfieldInvalidFormatMsg">Invalid format.</span></span></td>
                                          
                                          
                                          <td class="label">EL Khas Pemandu</td>
                                          <td colspan="inputlabel"><span class="inputlabel">RM</span><span id="elkdriver">
                                          <input name="useremolumen_elkdriver" type="text" class="w50" id="useremolumen_elkdriver" />
                                          <span class="textfieldInvalidFormatMsg">Invalid format.</span></span></td>
                                        </tr>
                                        <tr>
                                          <td class="label">Selenggara</td>
                                          <td colspan="inputlabel"><span class="inputlabel">RM</span><span id="el_selenggara">
                                          <input name="useremolumen_selenggara" type="text" class="w50" id="useremolumen_selenggara" />
                                          <span class="textfieldInvalidFormatMsg">Invalid format.</span></span></td>
                                          
                                          
                                          <td class="label"></td>
                                          <td colspan="inputlabel"><span class="inputlabel"></span><span>
                                  ...
                                  <div class="off">
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                      ...
                                      <tr class="<?php if($row_emo['useremolumen_status']=="1") echo "on"; else echo "offcourses";?>">
                                        ...
                                        <td align="center" valign="middle"><?php if($row_emo['useremolumen_elkdriver']=="") echo "0"; else echo $row_emo['useremolumen_elkdriver']; ?></td>
                                        <td align="center" valign="middle"><?php if($row_emo['useremolumen_selenggara']=="") echo "0"; else echo $row_emo['useremolumen_selenggara']; ?></td>
                                  ...
                                  <li>
                                    <form id="formlain" name="formlain" method="POST" action="<?php echo $url_main;?>sb/profile_admin.php?id=<?php echo $colname_userprofile;?>&url=edit">
                                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr>
                                          <td class="label">Potongan Kwsp</td>
                                          <td> <select name="userjob_kwsp_potong" id="kwsp_potong">
                                            <option value="0">0 - 0%</option>
                                            <option value="11">1 - 11%</option>
                                            <option value="5.5" selected="selected">2 - 5.5%</option>
                                            <option value="8" selected="selected">3- 8%</option>
                                            <option value="4" selected="selected">4 - 4%</option>
                                          </select>
                                          
                                          <?php echo getPotonganKwspByStafID($row_userprofile['user_stafid'])?>
                                        </td>
                              ...
                              <div id="etc">
                                <li>
                                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                      <td class="label">No. KWSP
                                        <br>
                                      <br> Potongan Kwsp</td>
                                      <td><?php if(checkKWSPByUserID($row_userprofile['user_stafid'])){ echo getKWSPByUserID($row_userprofile['user_stafid']); ?><?php } else echo "Tidak dinyatakan";?> <div class="inputlabel2"><?php echo getKWSPDateByStafID($row_userprofile['user_stafid']);?></div>
                                      <br><?php echo getPotonganKwspByStafID($row_userprofile['user_stafid'])?>
                                    </td>
                                    
                                    
                                    <td class="label">No. PERKESO</td>
                                    <td><?php if(checkPERKESOByUserID($row_userprofile['user_stafid'])){ echo getPERKESOByUserID($row_userprofile['user_stafid']); ?><?php } else echo "Tidak dinyatakan";?> <div class="inputlabel2"><?php echo getPERKESODateByStafID($row_userprofile['user_stafid']);?></div></td>
                                  </tr>
                                  <tr>
                                    
                                    <td class="label">No. LHDN</td>
                                    <td><?php if(checkLHDNByUserID($row_userprofile['user_stafid'])){ echo getLHDNByUserID($row_userprofile['user_stafid']); ?><?php } else echo "Tidak dinyatakan";?> <div class="inputlabel2"><?php echo getLHDNDateByStafID($row_userprofile['user_stafid']);?></div></td>
                                    <td class="label">Kelab MSN</td>
                                  ...
                                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                      ...
                                      <td width="100%">
                                        ...
                                        <select name="y" id="y">
                                          <?php for($pk=date('Y')-10; $pk<=date('Y')+100; $pk++){?>
                  ...
                  var sprytextfield24 = new Spry.Widget.ValidationTextField("elkdriver", "currency", {isRequired:false, hint:"0"});
                  var sprytextfield24 = new Spry.Widget.ValidationTextField("el_selenggara", "currency", {isRequired:false, hint:"0"});
                  ...
                  function CommaFormatted() {
                    ...
                    var amount= document.getElementById("usersalaryskill_basicsalary").value;
                    var amount2 = amount.replace(/,/g, '')
                    document.getElementById("usersalaryskill_basicsalary").value= amount2.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
                  }

                  function toggleview3(element1, param, id) {
debugger;
                    ...
                    if (element1.style.display == 'none' || element1.style.display == '')
                    {
                      ...
                      location.href = "edit.php?id="+id+"?param="+param;
                      // 
                        // mysql_select_db($database_hrmsdb, $hrmsdb);
                        // $query_tgupdate = sprintf("SELECT * FROM www.user_salaryskill WHERE user_stafid = %s AND usersalaryskill_id = %s", GetSQLValueString($colname_userprofile, "text"), $_POST['TG_update']);
                        // $tgupdate = mysql_query($query_tgupdate, $hrmsdb) or die(mysql_error());
                        // $row_tgupdate = mysql_fetch_assoc($tgupdate);
                        // $totalRows_tgupdate = mysql_num_rows($tgupdate);
                      // 
                    } else {  
