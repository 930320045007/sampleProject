...
$query_allleave = "SELECT userleavedate_id, userleavedate_note, clinictype_id FROM www.user_leavedate WHERE user_stafid = '" . $userid . "' AND userleavedate_date_y = '" . $y . "' AND (leavetype_id = '1' OR leavetype_id = '2' OR leavetype_id = '4' OR leavetype_id = '5' OR leavetype_id = '6' OR leavetype_id = '7' OR leavetype_id = '8' OR leavetype_id = '11') AND userleavedate_status = '1' AND userleavedate_app < '2' ORDER BY userleavedate_date_y ASC, userleavedate_date_m ASC, userleavedate_date_d ASC";
                ...
                <div class="off2">
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      ...
                      <th colspan="<?php if(getDesignationType($userid)) echo "8"; else echo "6"; ?>" align="center" valign="middle" nowrap="nowrap" class="line_l line_t">Baki Peruntukan</th>
                    ...
                    <tr>
                      ...
                      <th width="100" <?php if(getDesignationType($userid)) echo "rowspan=\"2\""; ?> align="center" valign="middle" nowrap="nowrap" class="line_l">Cuti Rehat <br /></th>
                      
                      <th width="100" <?php if(getDesignationType($userid)) echo "rowspan=\"2\""; ?> align="center" valign="middle" nowrap="nowrap" class="line_l"><br />
                      Cuti Ganti</th>
                      ...
                      <th width="100" <?php if(getDesignationType($userid)) echo "rowspan=\"2\""; ?> align="center" valign="middle" nowrap="nowrap" class="line_l">Cuti Khas<br />Lain-lain</th>
                    ...
                    <tr class="back_lightgrey">
					  ...
					  <?php $ddCuti = getLeave($userid, $y)+ countPLC2year($userid, $y) + getTotalLeaveKhasPerubatan($userid, $y);?>
					...
					<?php echo getTotalLeaveGanti($userid, $y);?></td>
                    ...
                    <?php if(getDesignationType($userid)){?>
                      ...
                      <td align="center" valign="middle" class="line_l"><strong><?php echo getLeaveKhas($userid, $y);?></strong></td>
                    ...
                    <?php do { ?>
                      ...
                      <tr class="on">
                        ...
                        <td align="center" valign="middle" nowrap="nowrap" class="line_l"><?php if(getStafIDByLeaveID($row_allleave['userleavedate_id'])==1){$ddCuti-=1; echo $ddCuti;}; ?> 
                        *</td>
                    ...
                    <?php if(getDesignationType($userid)){?>
                        ...
                        <td align="center" valign="middle" nowrap="nowrap" class="line_l"><?php if(getLeaveTypeByLeaveID($row_allleave['userleavedate_id'])==7){ echo getDayLeaveMTQByID($row_allleave['userleavedate_id']);}; ?><?php echo $row_allleave['userleavedate_note'];?></td>

                        <td align="center" valign="middle" nowrap="nowrap" class="line_l"><?php if(getLeaveTypeByLeaveID($row_allleave['userleavedate_id'])==7){ echo getDayLeaveKhasByID($row_allleave['userleavedate_id']);}; ?><?php echo $row_allleave['userleavedate_note'];?></td>

                        

                        <td class="line_l line_r"><?php if(getLeaveTypeByLeaveID($row_allleave['userleavedate_id'])==4 || getLeaveTypeByLeaveID($row_allleave['userleavedate_id'])==5 || getLeaveTypeByLeaveID($row_allleave['userleavedate_id'])==6 || getLeaveTypeByLeaveID($row_allleave['userleavedate_id'])==7 || getLeaveTypeByLeaveID($row_allleave['userleavedate_id'])==11) echo $row_allleave['userleavedate_note'];?></td>
