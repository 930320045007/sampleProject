...
if(isset($_GET['marital']))
	$m = htmlspecialchars($_GET['marital'], ENT_QUOTES);
else
	$m = $row_marital['marital_id'];

mysql_select_db($database_hrmsdb, $hrmsdb);
	$sql_where = " login.login_status = '1' AND userpersonal_marital = '" . $m . "' AND userdesignation_status = '1' AND user_designation.userdesignation_status = '1'";
	...
	<div>
        ...
        <div class="tabbox">
            ...
            <?php if(checkUserSysAcc($row_user['user_stafid'], $menu, $menu2, 1)){?>
              <li class="line_b">
                  <form id="form1" name="form1" method="get" action="stafflistnamebymarital.php">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td  class="label noline" nowrap="nowrap">Status Perkahwinan</td>
                        <td width="100%" class="noline">
                            <select name="marital" id="marital">
                            <?php
							do {  
							?>
                            <option <?php if($m == $row_marital['marital_id']) echo "selected=\"selected\"";?> value="<?php echo $row_marital['marital_id']?>"><?php echo $row_marital['marital_name']?></option>
                            <?php
