                  ...
                  <form id="form1" name="form1" method="get" action="stafleaveindv.php">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <?php for($i=0; $i <=17; $i++){?>
                          <option <?php if($i==$dm) echo "selected=\"selected\"";?> value="<?php if($i<13) $i = '0' . $i; echo date('m/Y', mktime(0, 0, 0, $i-0, 1, date('Y')));?>"><?php echo date('M Y', mktime(0, 0, 0, $i-0, 1, date('Y')));?></option>
                        <?php }; ?>
                        </select>
                        <input name="button3" type="submit" class="submitbutton" id="button3" value="Semak" />
                        </td>
                        <td class="noline"><input name="button3" type="button" class="submitbutton" id="button3" value="Cetak" onClick="MM_openBrWindow('thumbprintprint.php?id=<?php echo $sid;?>&m=<?php echo $dm;?>&y=<?php echo $dy;?>','printthumbprint','scrollbars=yes,width=800,height=600')" /></td><td class="noline"><input name="button4" type="button" class="submitbutton" id="button4" value="Harian" onclick="MM_goToURL('parent','stafleaveadmin.php');return document.MM_returnValue" /></td>
                      </tr>
                    </table>
                  </form>
                </li>
                <li>
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <th width="15%" align="center" valign="middle" class="line_l line_r line_t">Cuti</th>
                      <th width="20%" align="center" valign="middle" class="line_l line_r line_t">Kehadiran</th>
                      <th width="8%" align="center" valign="middle" class="line_l line_r line_t">Catatan</th>
                      <th width="20%" align="center" valign="middle" class="line_l line_r line_t">Pergerakan</th>
                    </tr>
					...
					?>
                    <tr class="<?php  ?>">
                    <td align="left" valign="middle" class="txt_line line_r line_l"><a href="staffleavehr.php?id=<?php echo getSoyalID($sid, $dd, $dm, $dy); ?>"><strong><?php echo date('d / m / Y (D)', mktime(0, 0, 0, $dm, $dd, $dy));?></strong></a></td>     
                     ...
                     <td align="left" valign="middle" class="txt_line line_r line_l"><?php 
                     $pergerakanIDByDateTemp = getNewPergerakanIDByDate($sid, $dd, $dm, $dy); 
                     if(count($pergerakanIDByDateTemp) > 0)
                          {
                            for($ii=0; $ii < count($pergerakanIDByDateTemp) ;$ii++)
                            {
                              echo "- ".getPergerakanStaffByID($pergerakanIDByDateTemp[$ii])."<br/>";
                            }
                          }
                     ?></div> 
