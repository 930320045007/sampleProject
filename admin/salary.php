...
<?php if(checkSalarySchDate($dy[0], $dy[1])){?>       

                       <td><input name="button5" type="button" class="submitbutton" id="button5" value="Cetak" onclick="MM_openBrWindow('printsalary.php?id=<?php echo $usersalary?>&m=<?php echo $dy[0];?>&y=<?php echo $dy[1];?>','salary','status=yes,scrollbars=yes,width=800,height=600')" /></td>
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    ...
                    <td align="left" valign="top" class="line_r"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <?php 
					  if(isset($_POST['useremolumen_elpksht'])) 
					  if($row_emo['useremolumen_elpksht']!=0 && $row_emo['useremolumen_elpksht']!=NULL){?>
                      ...
                      <?php 
					  if(isset($_POST['useremolumen_elmemangku'])) 
					  if($row_emo['useremolumen_elmemangku']!=0 && $row_emo['useremolumen_elmemangku']!=NULL){?> 
