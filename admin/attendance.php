           ...
           <table width="100%" border="0" cellspacing="0" cellpadding="0" class="form_table">
             ...
             <tr>
               ...
               <span id="emailpengguna"><span class="textfieldRequiredMsg">Maklumat diperlukan.</span>
                 <input name="isnmail" required="required" type="text" class="user txt_right in_lower" id="pengguna" autofocus="autofocus" onkeypress="return handleEnter(this, event)"/>
               </span>
               <div class="inputlabel">@nsc.gov.my</div>
               </td>
             </tr>
             <tr>
               <td nowrap="nowrap">Kata Laluan</td>
               <td>
               <input type="password" required="required" name="kt" id="katalaluan" onkeypress="return handleEnter(this, event)"/></td>
             </tr>
             <tr>
               <td>&nbsp;</td>
               <td><input name="button3" type="submit" class="submitbutton" id="button3" value="Kehadiran" /></td>
             </tr>
           </table>
         </form>
		 <?php } else { ?>
