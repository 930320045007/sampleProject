        ...
        <div class="tabbox">
        	...
        	<div class="profilemenu">
                ...
                <li>
                  ...
                  <div class="note">Senarai caruman <strong>Kelab MSN</strong> kakitangan bagi bulan <strong><?php echo date('M Y', mktime(0, 0, 0, $m, $d, $y));?></strong></div>
                ...
                <div>
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr class="on">
                      ...
                      <td align="center" valign="middle" nowrap="nowrap"><?php echo number_format(getKelabMSNRM($row_staf['user_stafid'], $d, $m, $y), 2);?></td>
