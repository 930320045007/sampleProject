              ...
              <ul>
                    ...
                    <form id="form1" name="form1" method="post" action="">
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr class="line_b4">
                          <td nowrap="nowrap" class="label noline">Carian</td>
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <?php $i=1; do { ?>
                      <tr class="on">
                        ...
                        <td>
                        <div class="txt_line"><strong><?php echo getFullNameByStafID($row_staflist['user_stafid']); ?></strong><br/>
                        <span class="txt_color1"><?php if(getCitizenByUserID($row_staflist['user_stafid'])=='130') echo getJobtitle($row_staflist['user_stafid']) . " (" . getGred($row_staflist['user_stafid']) . ")<br/>"; ?><?php echo getFulldirectoryByUserID($row_staflist['user_stafid']);?> &nbsp; &bull; &nbsp; <?php echo getLocationByUserID($row_staflist['user_stafid']);?></span></div>
                        </td>
                    ...
                    <tr>
                      <td colspan="4" align="center" valign="middle" class="noline txt_color1"><?php echo $totalRows_staflist ?> rekod dijumpai</td>
                    </tr>
                  <?php } else { ?>
                    <tr>
                      <td colspan="4" align="center" valign="middle" class="noline">Tiada rekod dijumpai. Sila pilih Bahagian / Cawangan / Pusat / Unit.</td>
                    </tr>
                  <?php }; ?>
                  </table>
                  </li>
