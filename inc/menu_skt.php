...
<div class="tab">
    <ul>
        <?php do { ?>
        <?php if((checkPPPByStafID($row_user['user_stafid']) && $row_menuICT['submenu_id'] == '59') || (checkPPKByStafID($row_user['user_stafid']) && $row_menuICT['submenu_id'] == '60')){?>
        ...
        <?php } else if($row_menuICT['submenu_id'] != '59' && $row_menuICT['submenu_id'] != '60'){ ?>
        <li <?php if($menu2==$row_menuICT['submenu_id']) echo "class=\"ontab\"";?>><a href="<?php echo $url_main . $row_menuICT['submenu_url']; ?>"><?php echo $row_menuICT['submenu_name']; ?></a></li>
        <?php }; ?>
