                  ...
                  <form id="form1" name="form1" method="get" action="stafleaveindv.php">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <?php for($i=1; $i<=12; $i++){?>
                          <option <?php if($i==$dm) echo "selected=\"selected\"";?> value="<?php if($i<10) $i = '0' . $i; echo date('m/Y', mktime(0, 0, 0, $i-1, 1, date('Y')));?>"><?php echo date('M Y', mktime(0, 0, 0, $i-1, 1, date('Y')));?></option>
                        <?php }; ?>
                        </select>
