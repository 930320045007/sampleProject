                ...
                <div>
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr class="on">
                      ...
                      <td align="center" valign="middle" nowrap="nowrap" <?php if(countLeaveCategoryByStafID($row_staf['user_stafid'], '9', $mc, '2014')=='0') echo "class=\"txt_color1\"";?>><?php echo countLeaveCategoryByStafID($row_staf['user_stafid'], '9', $mc, '2014');?></td>
                      <?php }; ?>
                      <td align="center" valign="middle" nowrap="nowrap"><?php echo countLeaveCategoryByStafID($row_staf['user_stafid'], '9', '0', '2014');?></td>
                    </tr>
