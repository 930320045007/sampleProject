...
<?php include('../inc/header.php');?>
        ...
        <div class="tabbox">
          ...
          <?php if(checkUserSysAcc($row_user['user_stafid'], $menu, $menu2, 2)){?>
            <div class="note">Setiap akaun baru perlu memiliki email rasmi ISN sebelum dapat mengakses maklumat dalam sistem ini. Sila berhubung dengan Unit ICT untuk maklumat berkaitan email.</div>
...
?>
  ...
  <tr>
    ...
    <td colspan="3">
      ...
      <input name="user_lastname" type="text" class="in_cappitalize w50" id="textfield5" /></span><div class="inputlabel2">Tanpa 'Bin / Binti'. Cth: Ahmad</div></td>
  </tr>
  <tr>
    <td class="label">Staf ID *</td>
    <td colspan="3"><div>Sila semak Staf ID sekali lagi bagi mengelakkan sebarang kesilapan</div><span id="userstafid"><span class="textfieldRequiredMsg">Maklumat diperlukan.</span>
      <input name="user_stafid" type="text" class="w10 in_upper" id="user_stafid" />
      </span>
      <div class="inputlabel2">Cth: P2020</div></td>
  </tr>
  <tr>
    <td nowrap="nowrap" class="label">No. Kad Pengenalan</td>
    <td colspan="3"><input name="user_noic" type="text" class="w50" id="user_noic" /><div class="inputlabel2">Tanpa simbol '-'. Cth: 881203065595</div></td>
    </tr>
  <tr>
...
?>
  ...
  <tr>
    ...
    <td colspan="4">
      ...
      <span class="inputlabel">/ </span><span id="date_in">
        <span class="textfieldRequiredMsg">Maklumat diperlukan</span><span class="textfieldInvalidFormatMsg">Sila pastikan Format Tahun dimasukkan dengan betul</span>
        <input name="userjob_start_y" type="text" class="w10" id="userjob_start_y" value="<?php echo date('Y');?>" size="4" /></span></td>
  </tr>
  <tr>
  ...
  <tr>
    <td nowrap="nowrap" class="label">Tarikh Mula Dilantik <br />Perkhidmatan Kerajaan</td>
    <td colspan="4">
    <select name="userjob_in_d" id="userjob_start_d">
      ...
      <input name="userjob_in_y" type="text" class="w25" id="userjob_in_y" value="<?php echo date('Y');?>" size="4" />
</span></td>
  </tr>
  <tr>
    <td class="noline">
