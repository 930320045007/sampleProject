	...
	<div>
        ...
        <div class="tabbox">
          <div class="profilemenu">
          	<ul>
            	<li class="form_back">
            	  <form id="shortby" name="shortby" method="post" action="stafflist.php">
                ...
                <div class="note">Senarai kakitangan</div>
                  ...
                  <?php if ($totalRows_staf > 0) { // Show if recordset not empty ?>
                    <tr>
                      ...
                      <th align="center" valign="middle" nowrap="nowrap">Umur</th>
                      <th align="center" valign="middle" nowrap="nowrap">Size</th>
                    ...
                    <?php $i=1; do { ?>
                      <tr class="on">
                        ...
                        <div><strong class="in_upper"><a href="edit.php?id=<?php echo $row_staf['user_id']; ?>"><?php echo getFullNameByStafID($row_staf['user_stafid']); ?> &nbsp; ( <?php echo $row_staf['user_stafid']; ?> )</a></strong></div>
                        ...
                        <td align="center" valign="middle"><?php echo getAgeByUserID($row_staf['user_stafid']);?></td>
                        <td align="center" valign="middle"><?php echo getSize($row_staf['user_stafid']);?></td>
