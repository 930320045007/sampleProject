	...
	<div>
        ...
        <div class="tabbox">
        	...
        	<div class="profilemenu">
                ...
                <form id="form1" name="form1" method="get" action="salarylistkasar.php">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td width="100%" class="noline">
                      ...
                      <?php for($i=(date('m')-16); $i<=(date('m')+2); $i++){?>
                ...
                <div class="off2">
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      ...
                      <th width="200" align="left" valign="middle" nowrap="nowrap">Nama</th>

                      <th align="center" valign="middle" nowrap="nowrap">Staf ID</th>

                      <th align="center" valign="middle" nowrap="nowrap">Jawatan</th>

                      <th width="200" align="left" valign="middle" nowrap="nowrap">Bhg</th>
                      ...
                      <th align="center" valign="middle" nowrap="nowrap">Gaji Kasar (RM)</th>
                       ...
                       <th align="center" valign="middle" nowrap="nowrap">Jumlah Potongan (RM)</th>
                       <th align="center" valign="middle" nowrap="nowrap">Gaji Bersih (RM)</th>
                    ...
                    <tr class="on">
                      ...
                      <td align="left" valign="middle"><a href="<?php echo $url_main;?>admin/salary.php?id=<?php echo getID($row_staf['user_stafid'],1);?>&amp;bulan=<?php echo $m . "/" . $y;?>"><?php echo getFullNameByStafID($row_staf['user_stafid'],1); ?></a></td>
                     ...
                     <td align="center" valign="middle" nowrap="nowrap"><?php echo number_format(getBasicSalaryByUserID($row_staf['user_stafid'], $d, $m, $y), 2);?></td>
                      ...
                      <td align="center" valign="middle" nowrap="nowrap"><?php echo number_format(getTotalSalaryByUserID($row_staf['user_stafid'], $d, $m, $y), 2);?></td>

                      <td align="center" valign="middle" nowrap="nowrap"><?php echo number_format(getTotalCutByUserID($row_staf['user_stafid'], $d, $m, $y), 2);?></td>
                      <td align="center" valign="middle" nowrap="nowrap"><?php echo number_format(getGajiBersihByUserID($row_staf['user_stafid'], $d, $m, $y), 2);?></td>
