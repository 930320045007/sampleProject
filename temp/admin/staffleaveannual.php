        ...
        <div class="tabbox">
        	<div class="profilemenu">
                ...
                <?php include('../inc/menu_senaraicuti.php');?>
          		<ul>
                 <li class="line_b">
                  <form id="form1" name="form1" method="get" action="staffleaveannual.php">
                ...
                <li>
                	<div class="note">Senarai cuti kakitangan bagi tahun <strong>2014<?php /*?><?php echo date('Y', mktime(0, 0, 0, 1, 1, date('Y')));?><?php */?></strong> </div>
                </li>
                ...
                <div>
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <?php }; ?>
                      <th align="center" valign="middle" nowrap="nowrap">BAKI</th>
                    ...
                    <tr class="on">
                      ...
                      <td align="center" valign="middle" nowrap="nowrap" <?php if(countLeaveTypeByStafID($row_staf['user_stafid'], '1', $mc, '2014')=='0') echo "class=\"txt_color1\"";?>><?php echo countLeaveTypeByStafID($row_staf['user_stafid'], '1', $mc, '2014');?></td>
                      <?php }; ?>
                      <td align="center" valign="middle" nowrap="nowrap"><?php echo countLeaveBalance($row_staf['user_stafid'], '2014');?></td>
                      <td align="center" valign="middle" nowrap="nowrap"><?php echo countLeaveTypeByStafID($row_staf['user_stafid'], '1', '0', '2014');?></td>
                    </tr>
