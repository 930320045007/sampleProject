                ...
                <div class="off2">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <th align="center" valign="middle" nowrap="nowrap">Jumlah <br />
                      Pendapatan</th>
                    ...
                    <tr class="on">
                      ...
                      <td align="center" valign="middle" nowrap="nowrap"><?php echo number_format(getKWSPStafRM($row_staf['user_stafid'], $d, $m, $y), 2);?></td>
                      <td align="center" valign="middle" nowrap="nowrap"><?php echo number_format(getKWSPEmpRM($row_staf['user_stafid'], $d, $m, $y), 2);?></td>
                    </tr>
