	...
	<div>
        ...
        <div class="tabbox">
            ...
            <?php if(checkUserSysAcc($row_user['user_stafid'], $menu, $menu2, 1)){?>
              <li class="line_b">
                  <form id="form1" name="form1" method="get" action="stafflistnamebyjobtype.php">
                ...
                <li>
                <div class="note">Senarai nama kakitangan berstatus <strong><?php echo getJobtypeByID($jtl);?></strong></div>
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
