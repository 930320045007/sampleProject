...
<?php
$updateGoTo = $url_main . "mbj/reportdetail.php?id=" . $_POST['userreport_id'];

if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "formfeedback"))
{
	if(checkFeedbackEnd($_POST['userreport_id'])){
	  $updateSQL = sprintf("UPDATE mbj.user_report SET userreport_star=%s, userreport_starby=%s, userreport_stardate=%s WHERE userreport_id=%s",
