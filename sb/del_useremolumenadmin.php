...
if(checkUserSysAcc($row_user['user_stafid'], 5, 5, 4))
{
	...
	if ((isset($_GET['delemo'])) && ($_GET['delemo'] != ""))
	{
		$deleteSQL = sprintf("UPDATE user_emolumen SET useremolumen_status = '0' WHERE useremolumen_id=%s AND user_stafid=%s",
							 GetSQLValueString($_GET['delemo'], "int"),
