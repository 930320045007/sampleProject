...
$query_claim = "SELECT * FROM tadbir.claim WHERE claim_date_y='" . $y . "' AND user_stafid = '" . $userclaim . "' AND claim_status= 1 " . $wsql . " ORDER BY claim_on_y DESC, claim_on_m DESC, claim_on_d DESC, claim_id ASC";
...
<?php include('../inc/header.php');?>
        ...
        <div class="tabbox">
            ...
            <ul>
			 ...
			 <li class="form_back">
               <form id="formcheckstaf" name="formcheckstaf" method="get" action="claimbydate.php">
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0" class="icon_table">
                  <tr>
                   ...
                   <div><?php echo getJobtitle($userclaim); ?> (<?php echo getGredByStafID($userclaim);?>), <?php echo getFulldirectoryByUserID($userclaim);?></div>
               ...
               <li>
               <div class="note">Senarai tuntutan kerja lebih masa <?php if($m!=0){?>yang diproses pada bulan <strong><?php echo date('F Y', mktime(0, 0, 0, $m, 1, $y));?></strong><?php } else { echo "yang diproses bagi tahun <strong>".$y."</strong>";};?></div>
               <div>
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
				<?php if ($totalRows_claim > 0) { // Show if recordset not empty ?>
                 ...
                 <?php $i=1; do { ?>
                    <tr class="on">
                      ...
                      <td class="line_l" align="center" valign="middle" nowrap="nowrap"><?php if($row_claim['claim_siang_h']!='0') echo $row_claim['claim_siang_h']." j";?> <?php if($row_claim['claim_siang_m']!='00') echo $row_claim['claim_siang_m']." m";?></td>
                      
                      <td class="line_l" align="center" valign="middle" nowrap="nowrap"><?php if($row_claim['claim_malamsiang_h']!='0') echo $row_claim['claim_malamsiang_h']." j";?> <?php if($row_claim['claim_malamsiang_m']!='00') echo $row_claim['claim_malamsiang_m']." m";?></td>
                      
                      <td class="line_l" align="center" valign="middle" nowrap="nowrap"><?php if($row_claim['claim_malamahad_h']!='0') echo $row_claim['claim_malamahad_h']." j";?> <?php if($row_claim['claim_malamahad_m']!='00') echo $row_claim['claim_malamahad_m']." m";?></td>
                      
                      <td class="line_l" align="center" valign="middle" nowrap="nowrap"><?php if($row_claim['claim_amsiang_h']!='0') echo $row_claim['claim_amsiang_h']." j";?> <?php if($row_claim['claim_amsiang_m']!='00') echo $row_claim['claim_amsiang_m']." m";?></td>
                      
                      <td class="line_l line_r" align="center" valign="middle" nowrap="nowrap"><?php if($row_claim['claim_ammalam_h']!='0') echo $row_claim['claim_ammalam_h']." j";?> <?php if($row_claim['claim_ammalam_m']!='00') echo $row_claim['claim_ammalam_m']." m";?></td>
                      
                      <td align="center" valign="middle" nowrap="nowrap"><?php if($row_claim['claim_total_h']!='0') echo $row_claim['claim_total_h']." j";?> <?php if($row_claim['claim_total_m']!='00') echo $row_claim['claim_total_m']." m";?></td>
                	</tr>
