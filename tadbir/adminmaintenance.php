...
$query_main = "SELECT * FROM tadbir.maintenance WHERE maintenance_status = 1 " . $wsql . " ORDER BY maintenance_y DESC, maintenance_m DESC, maintenance_d DESC";
...
<div>
	<div>
        ...
        <div class="tabbox">
            ...
            <li class="form_back">
              <form id="form1" name="form1" method="get" action="adminmaintenance.php">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td><input name="button3" type="button" class="submitbutton" id="button3" value="Agensi" onclick="MM_goToURL('parent','agency.php');return document.MM_returnValue" /></td>
                  </tr>
                </table>
              </form>
            </li>
                ...
                <li>
                  ...
                  <?php if ($totalRows_main > 0) { // Show if recordset not empty ?>
                    <tr>
                      ...
                      <th align="center" valign="middle" nowrap="nowrap">Pemohon</th>
                    ...
                    <?php $i=1; do { ?>
                  	<tr class="on">
                        ...
                        <td align="center" valign="middle" nowrap="nowrap"><?php echo getFullNameByStafID(getMaintenanceBy($row_main['maintenance_id'])) . " (" . getMaintenanceBy($row_main['maintenance_id']) . ")";?></td>
                    	<td align="left" valign="middle" class="txt_line">
                        <a href="adminmaintenancedetail.php?id=<?php echo getID(htmlspecialchars($row_main['maintenance_id'],ENT_QUOTES)); ?>">
