              ...
              <li>
                ...
                <?php if ($totalRows_staf > 0) { // Show if recordset not empty ?>
                  <tr>
                    ...
                    <th align="center" valign="middle" nowrap="nowrap">No. Kad Pengenalan</td>
                    <th width="30%" align="left" valign="middle" nowrap="nowrap">Jawatan</th>
                    <th align="left" valign="middle" nowrap="nowrap">Status</th>
                    <th width="30%" align="left" valign="middle" nowrap="nowrap">Bhg/Cwg</th>
                    <th align="left" valign="middle" nowrap="nowrap">Email</th>
                    <th width="30%" align="left" valign="middle" nowrap="nowrap">Alamat</th>
                    <th align="center" valign="middle" nowrap="nowrap">No. Tel (HP)</th>
                    <th align="center" valign="middle" nowrap="nowrap">No. Ext</th>
                    <th align="center" valign="middle" nowrap="nowrap">Tarikh Mula</th>
                    <th align="center" valign="middle" nowrap="nowrap">Saiz Baju</th>
                    <th width="30%" align="left" valign="middle" nowrap="nowrap">Waris</th>
                  ...
                  <tr class="on">
                    ...
                    <td align="left" valign="middle" nowrap="nowrap"><?php echo getJobtype($row_staf['user_stafid']); ?></td>
                    ...
                    <td align="left" valign="middle"><?php echo getAddressByStafID($row_staf['user_stafid']);?></td>
                    <td align="center" valign="middle" nowrap="nowrap"><?php echo getTelMByStafID($row_staf['user_stafid']);?></td>
                    <td align="center" valign="middle" nowrap="nowrap"><?php echo getExtNoByUserID($row_staf['user_stafid']);?></td>
                    <td align="center" valign="middle" nowrap="nowrap"><?php echo getServiceDate($row_staf['user_stafid']);?></td>
                    <td align="center" valign="middle" nowrap="nowrap"><?php echo getSize($row_staf['user_stafid']);?></td>
                    <td align="left" valign="middle" class="txt_line">
					<div><?php echo getHusbandWifeNameByID(getECByUserID($row_staf['user_stafid']));?></div>
                    <div><?php echo getHusbandWifeTelMByID(getECByUserID($row_staf['user_stafid']));?></div>
                    </td>
                    <td align="left" valign="middle" nowrap="nowrap">&nbsp;</td>
                  </tr>
                  <?php $i++; } while ($row_staf = mysql_fetch_assoc($staf)); ?>
                  <tr>
                    <td colspan="15" align="center" valign="middle" class="txt_color1 noline"><?php echo $totalRows_staf; ?> rekod dijumpai</td>
                  </tr>
                  <?php } else { ?>
                  <tr>
