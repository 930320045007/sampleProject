...
mysql_select_db($database_ictdb, $ictdb);
echo $query_symptom = "SELECT * FROM ict.report_symptom WHERE reporttype_id = '" . $rt . "' AND reportsubtype_id = '" . $rst . "' AND reportsymptom_status = '1' AND EXISTS (SELECT * FROM report_answer WHERE report_answer.reportsymptom_id = report_symptom.reportsymptom_id AND report_answer.reportanswer_status='1')";
				  ...
				  <li class="form_back">
                    ...
                    <?php if(isset($_GET['rt']) && isset($_GET['rst'])){?>
                        ...
                        <?php } else { ?>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td width="100%" align="center" class="noline txt_line">Tiada isu yang direkodkan. Sila emailkan aduan anda ke email berikut <strong>support[at]isn.gov.my</strong> dengan menyertakan<br />
                    ...
                    <li>
                   	  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    	  <tr>
                            ...
                            <br />
                            <div class="note">Jika isu yang dihadapi tiada dalam senarai, sila emailkan aduan anda ke <strong>support[at]isn.gov.my</strong> dengan menyertakan
                            <br />
