                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td colspan="3" width="100%"><span class="noline">
                          <select name="vendortype_id" id="vendortype_id">
							...
							do {  
							?>
                            <option value="<?php echo $row_vtype['vendortype_id']?>"><?php echo $row_vtype['vendortype_name']?></option>
                            <?php
                      ...
                      <tr>
                        ...
                        <td colspan="3"><span id="nama"><span class="textfieldRequiredMsg">Maklumat diperlukan.<br/></span>
                          <input type="text" name="vendor_name" id="vendor_name" onkeypress="return handleEnter(this, event)" />
                       </span></td>
                      </tr>
                      <tr>
                        <td nowrap="nowrap" class="label">Alamat</td>
                        <td colspan="3"><textarea name="vendor_add" id="vendor_add" cols="45" rows="5"></textarea></td>
                      </tr>
                      <tr>
                        <td nowrap="nowrap" class="label">No. Tel</td>
                        <td width="50%"><input name="vendor_notel" type="text" id="vendor_notel" onkeypress="return handleEnter(this, event)" /></td>
                        <td nowrap="nowrap" class="label">No. Fax</td>
                        <td width="50%"><input name="vendor_nofax" type="text" id="vendor_nofax" onkeypress="return handleEnter(this, event)" /></td>
                      </tr>
                      <tr>
                        <td nowrap="nowrap" class="label">Email</td>
                        <td class="w30"><input name="vendor_email" type="text" id="vendor_email" onkeypress="return handleEnter(this, event)" /></td>
                        <td nowrap="nowrap" class="label">Website</td>
                        <td class="w30"><input name="vendor_web" type="text" id="vendor_web" onkeypress="return handleEnter(this, event)" /></td>
                      </tr>
                      <tr>
                        <td nowrap="nowrap" class="label noline"><input type="hidden" name="MM_insert" value="form1" /></td>
                        <td colspan="3" class="noline"><input name="button3" type="submit" class="submitbutton" id="button3" value="Tambah" />
