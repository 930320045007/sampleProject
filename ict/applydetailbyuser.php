	...
	<div>
        ...
        <div class="tabbox">
          ...
          <?php if (getJob2ID($row_user['user_stafid'])!=0){ ?>
           <div class="note">Rekod permohonan peralatan bagi kakitangan berikut</div>
                <ul>
                	<li>
                      ...
                      <?php if ($totalRows_itemapply > 0) { // Show if recordset not empty ?>
                        ...
                        <?php $i=1; do { ?>
                          <tr class="on">
                            ...
                            <td align="left" valign="middle" nowrap="nowrap"><?php echo getItemCategoryBySubCatID($row_itemapply['subcategory_id']) . " &nbsp; &bull; &nbsp; " . getItemSubCategoryByID($row_itemapply['subcategory_id']); ?></td>
