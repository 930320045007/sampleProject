          	...
          	<ul>
                ...
                &nbsp;
            	  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="icon_table">
            	    <tr>
                      ...
                      <div>Baki Cuti Rehat / Tahunan<?php if(getDesignationType($row_user['user_stafid'])) echo " + Cuti Dibawa Kehadapan";?>  &sup1;</div>
                      <div class="txt_size1"><?php echo countLeaveBalance($row_user['user_stafid'],date('Y'));?> <span class="txt_size2">Hari</span></div>
                      <div>Baki Cuti Ganti<?php if(getDesignationType($row_user['user_stafid']));?>  &sup1;</div>
                      <div class="txt_size1"><?php echo countLeaveGantiBalance($row_user['user_stafid'],date('Y'));?> <span class="txt_size2">Hari</span></div></td>
            	      <td class="icon_pad1 line_l"><?php echo viewProfilePic(getHeadIDByUserID($row_user['user_stafid']));?></td>
            	      <td class="w50 txt_line">
				...
				<?php 
				   ...
				   for($i=0; $i<2; $i++)
				   {
					 ...
					 // $year=date("Y", strtotime("+$i month", $date));
					...
					// {
						...
						// echo "<tr><td class=\"back_lightgrey txt_color1 line_r line_b3\" align=\"center\">Ahad</td><td class=\"line_r line_b3\" align=\"center\">Isnin</td><td class=\"line_r line_b3\" align=\"center\">Selasa</td><td class=\"line_r line_b3\" align=\"center\">Rabu</td><td class=\"line_r line_b3\" align=\"center\">Khamis</td><td class=\"line_r line_b3\" align=\"center\">Jumaat</td><td class=\"back_lightgrey txt_color1 line_r line_b3\" align=\"center\">Sabtu</td></tr>";
						  ...
						  echo "<tr><td class=\"line_r line_b3\" align=\"center\">Ahad</td><td class=\"line_r line_b3\" align=\"center\">Isnin</td><td class=\"line_r line_b3\" align=\"center\">Selasa</td><td class=\"line_r line_b3\" align=\"center\">Rabu</td><td class=\"line_r line_b3\" align=\"center\">Khamis</td><td class=\"line_r line_b3\" align=\"center\">Jumaat</td><td class=\"line_r line_b3\" align=\"center\">Sabtu</td></tr>";
						 ...
						 while ( $day_num <= $days_in_month )
						 {
							...
							if($day_num<10)
							 ...
							 //EDIT ENABLE HOLIDAY SATURDAY SUNDAY
							...
							{
							 	echo "<td width=\"17%\" class=\"backch line_r\" id=\"C" . $day_num . $month . $year . "\"><input class=\"w25\" onclick=\"color('C" . $day_num . $month . $year . "', 'R" . $day_num . $month . $year . "')\" name=\"listday[]\" type=\"checkbox\" id=\"R" . $day_num . $month . $year . "\" value=\"" . $day_num . "/" . $month . "/" . $year ."\"/>" . $day_num;
...
<input type="hidden" name="MM_insert_leavedate" value="formleavedate" /></td>
                ...
                <div class="note">
                    ...
                    <div>
                        <ol>
                            <li>Borang ini hanya untuk permohonan Cuti Rehat / Tahunan sahaja. Untuk Cuti Ganti, Cuti Sakit, Cuti Bersalin, Cuti Tanpa Gaji, dan Cuti Tanpa Rekod, sila berhubung dengan <?php echo $adname;?>.</li>
                            <li>Permohonan Cuti Rehat / Tahunan yang lambat dihantar ( selepas <b> <?php echo date('d/m/Y') ;?> </b> ) akan dikira sebagai Cuti Kecemasan (EL).</li><li>Cuti keluar negara (secara peribadi / agensi ) perlu mengisi Borang Lawatan Keluar Negara daripada <?php echo $adname;?>.</li>
                       </ol>
                    </div>
                </div>
                </li>
