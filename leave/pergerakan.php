        ...
        <div class="profilemenu">
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" id="TablePergerakan">
                    ...
                    <tr>
						...
						{	
							...
							{
								echo "<th align=\"center\" style=\"position:sticky; top: 0px; background-color:white;\" class=\"line_r\" id=\"CC" . $day_num . $month . "\">";
								echo $day_num;
								echo "</th>";
							}					
							$day_num++; 
                    ...
                    <tr class="on">
                      ...
                      <td align="center" style="position:sticky; left: 0px; background-color:white;" class="back_lightgrey line_r">
                      ...
                      <?php
						...
						{	
							...
							else if(getLeaveID($id, 1, $day_num, $month, $year))
							{
							 ...
							 {								
								$pergerakanIDTemp1 = getPergerakanID($id, $day_num, $month, $year);
								$pergerakanID = $pergerakanIDTemp1[0]['pergerakan_id'];
								for($i=0; $i < count($pergerakanIDTemp1) ;$i++)
								{
									$arrId[$i]= $pergerakanIDTemp1[$i];
								}

								$pergerakanValue = getPergerakanLocationByID($id, $day_num, $month, $year);
								echo "<td class=\"backch line_r\" style=\"background-color:#9C0;\">";					
								...
								echo "</tr>";
								echo "<tr>";
								// echo "<td nowrap=\"nowrap\"class=\"back_white label\">Maklumat Pergerakan</td>";
								...
								for($v=0; $v < count($arrId) ;$v++)
								{

									if(isset($pergerakanValue[$v]['pergerakan_location']))
									{
										echo "<tr id='tambah". $pergerakanIDTemp1[$v]['pergerakan_id'] . "'>";
										echo "<td nowrap=\"nowrap\"class=\"back_white label\">Maklumat Pergerakan</td>";
										echo "<td class=\"back_white\" width=\"100%\"><input name=\"lokasi_baru\" required=\"required\" type=\"text\" id=\"lokasi_baru".$pergerakanIDTemp1[$v]['pergerakan_id']."\" value='" . $pergerakanValue[$v]['pergerakan_location'] . "'\>";
										echo "<tr>";
									}
								...
								// echo "<td class=\"back_white\" width=\"100%\"><input name=\"lokasi_baru\" required=\"required\" type=\"text\" id=\"lokasi_baru".$pergerakanID."\" value='" . $pergerakanValue[0]['pergerakan_location'] . "'\>";
								...
								echo "<td class=\"back_white\" width=\"100%\">";
								echo "<input name=\"button\" type=\"button\" class=\"submitbutton\" id=\"button\" value=\"Kemaskini\" onclick=\"updatelocation(".str_replace('"',"'",json_encode($pergerakanIDTemp1)).", '".$day_num."', '".$month."', '".$id."');\" /><input name=\"button\" type=\"button\" class=\"cancelbutton\" id=\"button\" value=\"Batal\" onclick=\"toggleview('edit_lokasi". $pergerakanID ."','form_lokasi". $pergerakanID ."'); return false;\" />";
								echo "</td>";
								echo "</tr>";
								echo "</table>";
								echo "</li>";
								...
								echo "<tr>";
								echo "<td colspan=\"2\" class=\"title noline\">" . date('d / m / Y (D)', mktime(0, 0, 0, $month, $day_num, $year));
								if(!$maintenance || checkUserSysAcc($_SESSION['user_stafid'])){
									echo "<span class=\"fr add\" onclick=\"toggleview('edit_lokasi". $pergerakanID ."','form_lokasi". $pergerakanID ."'); return false;\">Kemaskini</span>";
							 	}								
								echo "</td>";
								echo "</tr>";
								...
								for($ii=0; $ii < count($arrId) ;$ii++)
								{
									...
									if(isset($pergerakanValue[$ii]['pergerakan_location']))
									{
										echo "<tr>";
										echo "<td nowrap=\"nowrap\" class=\"back_white label\">Maklumat Pergerakan</td>";
										echo "<td class=\"back_white\" width=\"100%\">" . $pergerakanValue[$ii]['pergerakan_location'] . "</td>";
										echo "</tr>";
									}
								...
								echo "<input type=\"button\" name=\"button2\" id=\"button2\" value=\"OK\" class=\"submitbutton\" onclick=\"toggleview2('Pergerakan" . $pergerakanID . "'); return false;\" />";
								echo "</td>";
								echo "</tr>";
								echo "</table>";
								echo "</li>";
								...
								echo "<div class=\"cursorpoint txt_color1\" onclick=\"toggleview2('Pergerakan" . $pergerakanID . "'); return false;\">";					
								// echo shortText(getPergerakanLocationByID($id, $day_num, $month, $year), 20) . " &nbsp; ";
								for($b=0; $b < count($arrId) ;$b++)
								{

									if(isset($pergerakanValue[$b]['pergerakan_location']))
									{
										echo '-'. shortText($pergerakanValue[$b]['pergerakan_location'], 20) . " <br/> ";
									}
								}
								echo "</td>";
						 	 }
          ...
          <form action="<?php echo $url_main;?>sb/add_pergerakan.php" name="pergerakan" method="POST" id="pergerakan" >
					...
					{ 
						...
						while ( $day_num <= $days_in_month )
						{
							...
							else if(getLeaveID($id, 1, $day_num, $month, $year))
							{
							 ...
							 {								
								$pergerakanIDTemp = getPergerakanID($id, $day_num, $month, $year);
								for($i=0; $i < count($pergerakanIDTemp) ;$i++)
								{
									$arrId[$i]= $pergerakanIDTemp[$i];
								}
								$string = json_encode($arrId);
								$string1 = str_replace('"',"'",$string);
								$pergerakanID = $pergerakanIDTemp[0]['pergerakan_id'];
								// $pergerakanID2 = $pergerakanIDTemp[1]['pergerakan_id'];
								$pergerakanValue = getPergerakanLocationByID($id, $day_num, $month, $year);
								echo "<td width=\"16%\" class=\"backch line_r\">";					
								echo "<div class=\"passbox_back hidden2\" id=\"Pergerakan" . $pergerakanID . "\">";
								//edit toggle form
								...
								echo "</td>";
								echo "</tr>";
								echo "<tr id='tambah". $pergerakanID . "'>";
								echo "<td nowrap=\"nowrap\"class=\"back_white label\">Maklumat Pergerakan</td>";
								echo "<td class=\"back_white\" width=\"100%\"><input name=\"lokasi_baru\" required=\"required\" type=\"text\" id=\"lokasi_baru".$pergerakanID."\" value='" . $pergerakanValue[0]['pergerakan_location'] . "'\>";

								// if(isset($pergerakanValue[1]['pergerakan_location']))
								// echo count($arrId);
								// echo $day_num;
								// if(count($arrId) > 1)
								// {
								// echo "masuk ada data lebih";
								echo "<i id='btnAdd". $pergerakanID . "' class=\"fa fa-plus-square\" style=\"font-size:36px; padding-left: 5px; cursor: pointer;\" onclick=\" test(".str_replace('"',"'",json_encode($pergerakanIDTemp))."); \" ></i>";
								// echo "<i id=\"btnAdd\" class=\"fa fa-plus-square\" style=\"font-size:36px; padding-left: 5px;\" onclick=\" ".$flag='true'." \" ></i>";
								// echo "<i id=\"btnAdd\" class=\"fa fa-plus-square\" style=\"font-size:36px; padding-left: 5px;\" onclick= ".flag()." ></i>";
								// for($g =0 ; $g < 3; $g++)
								// {
								// 	echo "<tr id='tambah". $pergerakanID . "'>";
								// 	echo "<td nowrap=\"nowrap\"class=\"back_white label\">Maklumat Pergerakan</td>";
								...
								// }
								// else{
								// 	echo str_replace('"',"'",json_encode($pergerakanIDTemp));
								// 	// echo $string1;
								// 	echo "masuk satu je data";
								// 	echo "<i id=\"btnAdd\" class=\"fa fa-plus-square\" style=\"font-size:36px; padding-left: 5px;\" onclick=\" test(".str_replace('"',"'",json_encode($pergerakanIDTemp))."); \" ></i>";  // if ada satu je
								// }
								
								
								// echo "<br/>";
								// echo "<tr>";
								// echo "<td nowrap=\"nowrap\"class=\"back_white label\">Maklumat Pergerakan Baharu</td>";
								...
								for($ii=1; $ii < count($arrId) ;$ii++)
								{

									if(isset($pergerakanValue[$ii]['pergerakan_location']))
									{
										echo "<tr id='tambah". $pergerakanIDTemp[$ii]['pergerakan_id'] . "'>";
										echo "<td nowrap=\"nowrap\"class=\"back_white label\">Maklumat Pergerakan</td>";
										echo "<td class=\"back_white\" width=\"100%\"><input name=\"lokasi_baru\" required=\"required\" type=\"text\" id=\"lokasi_baru".$pergerakanIDTemp[$ii]['pergerakan_id']."\" value='" . $pergerakanValue[$ii]['pergerakan_location'] . "'\>";
										echo "<tr>";
									}
								...
								echo "<td nowrap=\"nowrap\" class=\"back_white\"></td>";
								echo "<td class=\"back_white\" width=\"100%\">";
								echo "<input name=\"button\" type=\"button\" class=\"submitbutton\" id=\"button\" value=\"Kemaskini\" onclick=\"updatelocation(".str_replace('"',"'",json_encode($pergerakanIDTemp)).", '".$day_num."', '".$month."', '".$id."');\" /><input name=\"button\" type=\"button\" class=\"cancelbutton\" id=\"button\" value=\"Batal\" onclick=\"toggleview('edit_lokasi". $pergerakanID ."','form_lokasi". $pergerakanID ."'); return false;\" />";
								echo "</td>";
								echo "</tr>";
								echo "</table>";
								echo "</li>";
								echo "</div>";
								//tutup edit toggle form
								...
								echo "<tr>";
								echo "<td colspan=\"2\" class=\"title noline\">" . date('d / m / Y (D)', mktime(0, 0, 0, $month, $day_num, $year));
								// echo "<a onclick=\"myFunction(); return false;\">cubaan</a>"
								// echo !$maintenance;
								...
								echo "<tr>";
								// echo "<td nowrap=\"nowrap\" class=\"back_white label\">Maklumat Pergerakan</td>";
								// echo "<td class=\"back_white\" width=\"100%\">" . $pergerakanValue[0]['pergerakan_location'] . "</td>";
								echo "</tr>";
								for($m = 0 ; $m < count($arrId) ; $m++)
								{
									if(isset($pergerakanValue[$m]['pergerakan_location']))
									{
										echo "<tr>";
										echo "<td nowrap=\"nowrap\" class=\"back_white label\">Maklumat Pergerakan</td>";
										echo "<td colspan=\"2\" class=\"back_white\" width=\"100%\">" . $pergerakanValue[$m]['pergerakan_location'];
										echo "<span id='btnDel". $pergerakanID . "' class=\"fa fa-times fr\" style=\"font-size:30px; padding-left: 5px; cursor: pointer;\" onclick=\" deletePergerakan(".$pergerakanIDTemp[$m]['pergerakan_id'].") \" ></span>";
										echo "</td>";
										echo "</tr>";
									}
								}
								...
								// if(getPergerakanLocationByID($id, $day_num, $month, $year) == true){
								// 	echo "<input type=\"button\" name=\"button2\" id=\"button2\" value=\"Simpan\" class=\"submitbutton\" onclick=\"toggleview3('Pergerakan" . getPergerakanID($id, $day_num, $month, $year) . "'); return false;\" />";
								// }
								echo "<td class=\"back_white\" width=\"100%\">";
								echo "<input type=\"button\" name=\"button2\" id=\"button2\" value=\"OK\" class=\"submitbutton\" onclick=\"toggleview2('Pergerakan" . $pergerakanID . "'); return false;\" />";
								echo "</td>";
								...
								echo "</div>";
								echo "</div>";
								echo "<div class=\"txt_color1 cursorpoint\" onclick=\"toggleview2('Pergerakan" . $pergerakanID . "'); return false;\">";
								
								
								
								echo $day_num . " - " . shortText($pergerakanValue[0]['pergerakan_location'], 20) . " &nbsp; <br/> &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" ;
								// echo $pergerakanValue[1]['pergerakan_location'];
								for($m = 1 ; $m < count($arrId) ; $m++)
								{
									if(isset($pergerakanValue[$m]['pergerakan_location']))
									{
										echo "- " . shortText($pergerakanValue[$m]['pergerakan_location'], 20). " &nbsp; <br/> &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
									}
								}
								
								echo "</td>";
						 	 }
							 else if($year==date('Y') && $month==date('m') && $day_num < date('d')-30 || $year==date('Y') && $month<date('m')-1) // check previous day
            ...
            <li>
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td nowrap="nowrap" class="label">Maklumat Pergerakan  *</td>
                  <td width="100%" colspan="3"><label for="userleavestatus_name"></label>
                    ...
                    <input name="pergerakan_lokasi" required="required" type="text" id="pergerakan_lokasi" maxlength="300" onkeypress="return handleEnter(this, event)"/>
                    <div class="inputlabel2">Cth: Mesyuarat di KBS pada pukul 10.00pagi</div>
                    </span></td>
                </tr>
                <tr>
...
function deletePergerakan(id){
	...
	xmlhttp.open("GET","delete_pergerakan.php?id="+id,true);
	xmlhttp.send();

	setTimeout(function(){ 
			window.location.reload();
			alert('Maklumat telah berjaya dipadam.');
		}, 1000);
...
function updatelocation(id, day, month, user) {
	
	// var str = document.getElementById("lokasi_baru"+id[0]['pergerakan_id']).value;
	// var str1 = document.getElementById("lokasi_baru"+id[1]['pergerakan_id']).value;
	...
	{
		var array = document.getElementById("lokasi_baru"+id[a]['pergerakan_id']).value;
		xmlhttp.open("GET","update_pergerakan.php?val="+array+"&id="+id[a]['pergerakan_id'],true);
		xmlhttp.send();
	}

	// debugger;
	if(document.getElementById("lokasi_baru") != null)
	{
		var str = document.getElementById("lokasi_baru").value;
		xmlhttp.open("GET","add_pergerakan_new.php?pergerakan_lokasi="+str+"&user_stafid="+user+"&day="+day+"&month="+month,true);
		xmlhttp.send();
	}
...
{  
	...
	createElement.innerHTML = "<td id=\"addColumn\" nowrap=\"nowrap\"class=\"back_white label\">Maklumat Pergerakan Baharu</td> <td class=\"back_white\" width=\"100%\"> <input name=\"lokasi_baru\" id=\"lokasi_baru\" required=\"required\" type=\"text\"  value=\"\" \> </td> ";
	// createElement.innerHTML = "<td id=\"addColumn\" nowrap=\"nowrap\"class=\"back_white label\">Maklumat Pergerakan new</td> <td class=\"back_white\" width=\"100%\"> <input name=\"lokasi_baru\" id=\"lokasi_baru"+id[0]['pergerakan_id']+"\" required=\"required\" type=\"text\"  value=\""+val2[0]['pergerakan_location']+"\" \> </td> ";
	var tempElement = document.getElementById("tambah"+id[0]['pergerakan_id']);
	insertAfter(tempElement, createElement);
	
	var btn = document.getElementById('btnAdd'+id[0]['pergerakan_id']);
	...
	// var createElement = document.createElement("tr");
	// createElement.innerHTML = "<td id=\"addColumn\" nowrap=\"nowrap\"class=\"back_white label\">Maklumat Pergerakan new</td> <td class=\"back_white\" width=\"100%\"> <input name=\"lokasi_baru\" id=\"lokasi_baru"+id2+"\" required=\"required\" type=\"text\"  value=\""+val2+"\" \> </td> ";
	// var tempElement = document.getElementById("tambah"+id);
	// insertAfter(tempElement, createElement);
	return btn;
