                ...
                <div>
            	  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="icon_table">
            	    <tr>
            	      ...
            	      <td class="line_r w50 txt_line"><div>Baki Cuti Rehat / Tahunan <?php if(getDesignationType($row_user['user_stafid'])) echo " + Cuti Dibawa Kehadapan";?>  &sup1;</div>
                      ...
                      <div class="txt_size1"><?php echo getTotalLeaveGanti($row_user['user_stafid'],date('Y'));?> <span class="txt_size2">Hari</span></div></td>
