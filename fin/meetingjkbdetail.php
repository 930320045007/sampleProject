...
mysql_select_db($database_financedb, $financedb);
$query_apply = sprintf("SELECT * FROM finance.apply WHERE apply_status = 1 AND jkb_id = %s ORDER BY jkb_id ASC", GetSQLValueString($colname_jkb, "int"));
     ...
     <?php include('../inc/menu_tadbir_user.php');?>
        <div class="tabbox">
            ...
            <?php if(checkUserSysAcc($row_user['user_stafid'], $menu, $menu2, 1)){?>
                ...
                <li>
                   <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                          ...
                          <td><?php echo $row_jkb['jkb_detail'];?></td>
                        </tr>
                      </table>
                    </li>
                    <li class="gap">&nbsp;</li>
                    ...
                    <li>
                     ...
                     <form id="form1" name="form1" method="post" action="../sb/update_jkbstatus.php">
                      ...
                      <?php echo "<a href=\"editapply.php?appid=" . htmlspecialchars($row_apply['apply_id'], ENT_QUOTES) . "&id=" . htmlspecialchars($colname_jkb, ENT_QUOTES) . "\">Edit</a>"; ?>
                      <?php }; ?>
                      </ul>
                      </td>
                          </tr>
                ...
                <?php if(!checkJKBApp($colname_jkb)){?>
                <li class="gap">&nbsp;</li>
                <li>
                  <form id="form1" name="form1" method="POST" action="../sb/update_jkbapp.php">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                     <tr>
                        <td class="label">Bilangan Mesyuarat</td>
                      <td width="100%" nowrap="nowrap"><select name="bil_id" id="bil_id">
      <?php
do {  
?>
      <option value="<?php echo $row_bil['bil_id']?>"><?php echo $row_bil['bil_no'] ."/". date('Y', mktime(0, 0, 0, 1,1, $row_bil['bil_date_y']));?></option>
      <?php
...
?>
                      ...
                      <tr>
                        ...
                        <td><ul class="inputradio">
                          <li><input name="jkb_appby" type="radio" value="1" checked /><?php echo getJob2Name('2');?></li>
                          <li><input name="jkb_appby" type="radio" value="2" />PENGARAH BAHAGIAN</li>
                          <li><input name="jkb_appby" type="radio" value="3" />AHLI MESYUARAT</li>
                        </ul></td>
                      </tr>
                      <tr>
                        <td class="label">Tarikh Pengesahan</td>
                        <td>
                        <select name="jkb_appdate_d" id="jkb_appdate_d">
                        <?php for($i=1; $i<=31; $i++){?>
                        <option <?php if($i==date('d')) echo "selected=\"selected\"";?> value="<?php if($i<10) $i = '0' . $i; echo $i;?>"><?php echo $i;?></option>
                        <?php }; ?>
                        </select>
                        <select name="jkb_appdate_m" id="jkb_appdate_m">
                        <?php for($j=1; $j<=12; $j++){?>
                        ...
                        <select name="jkb_appdate_y" id="jkb_appdate_y">
                      ...
                      <tr>
                        ...
                        <td><textarea name="jkb_appnote" id="jkb_appnote" cols="45" rows="5"></textarea></td>
                      </tr>
                      <tr>
                        <td class="noline"><input type="hidden" name="MM_update" value="form1" />                          <input name="jkb_id" type="hidden" id="jkb_id" value="<?php echo $colname_jkb;?>" /></td>
