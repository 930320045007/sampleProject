	...
	<div>
        ...
        <div class="tabbox">
        	<div class="profilemenu">
                ...
                <li>
                <li>
                  <div class="note">Senarai <strong>KWSP</strong> kakitangan bagi bulan <strong><?php echo date('M Y', mktime(0, 0, 0, $m, $d, $y));?></strong></div>
                </li>
                ...
                <div class="off2">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <th align="center" valign="middle" nowrap="nowrap">Gaji <br />
                      Pokok</th>
                      <th align="center" valign="middle" nowrap="nowrap">%</th>
                      <th align="center" valign="middle" nowrap="nowrap">KWSP <br />
                      (Pekerja) (RM)</th>
                      <th align="center" valign="middle" nowrap="nowrap">KWSP<br />
                        (Majikan)(RM)</th>
                    </tr>
                    ...
                    <tr class="on">
                      ...
                      <td align="center" valign="middle" nowrap="nowrap"><?php echo getKWSPByUserID($row_staf['user_stafid']);?></td>
                      <td align="center" valign="middle" nowrap="nowrap"><?php echo number_format(getBasicSalaryByUserID($row_staf['user_stafid'], $d, $m, $y), 2);?></td>
                      <td align="center" valign="middle" nowrap="nowrap"><?php echo getKWSPStafPercByStafID($row_staf['user_stafid'], $d, $m, $y);?></td>
                      <td align="right" valign="middle" nowrap="nowrap"><?php echo number_format(getKWSPStafRM($row_staf['user_stafid'], $d, $m, $y), 2);?></td>
                      <td align="right" valign="middle" nowrap="nowrap"><?php echo number_format(getKWSPEmpRM($row_staf['user_stafid'], $d, $m, $y), 2);?></td>
                    </tr>
      				<?php $i++; } while ($row_staf = mysql_fetch_assoc($staf)); ?>
                    <tr class="back_lightgrey">
                      <td colspan="9" align="right" valign="middle"><strong>Jumlah (RM)</strong></td>
                      <td align="right" valign="middle" nowrap="nowrap"><strong><?php echo number_format(getTotalKWSPStafTetap($d, $m, $y)+getTotalKWSPStafKontrak($d, $m, $y), 2);?></strong></td>
                      <td align="right" valign="middle" nowrap="nowrap"><strong><?php echo number_format(getTotalKWSPEmpTetap($d, $m, $y)+getTotalKWSPEmpKontrak($d, $m, $y), 2);?></strong></td>
                    </tr>
                  </table>
                </div>
                </li>
