                ...
                <div>
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr class="back_lightgrey">
                      <td colspan="7" align="right" valign="middle"><strong>Jumlah Keseluruhan</strong></td>
                      <td align="right" valign="middle" nowrap="nowrap"><strong><?php echo number_format(getTotalTransactionSalary($tt, $d, $m, $y), 2);?></strong></td>
                    </tr>
                  </table>
                </div>
                </li>
