        ...
        <div class="tabbox">
        	<div class="profilemenu">
                ...
                <?php include('../inc/menu_senarai_fin.php');?>
          		<ul>
                <li class="line_b">
                <form id="form1" name="form1" method="get" action="kelabMSNlist.php">
                ...
                <li>
                <li>
                  <div class="note">Senarai caruman <strong>Kelab ISN</strong> kakitangan bagi bulan <strong><?php echo date('M Y', mktime(0, 0, 0, $m, $d, $y));?></strong></div>
                </li>
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <th align="center" valign="middle" nowrap="nowrap">Gaji<br />
                        Pokok</th>
                      <th align="center" valign="middle" nowrap="nowrap">Caruman<br />
                      (RM)</th>
                    </tr>
                    ...
                    <tr class="on">
                      ...
                      <td align="right" valign="middle" nowrap="nowrap"><?php echo number_format(getKelabMSNRM($row_staf['user_stafid'], $d, $m, $y), 2);?></td>
                    </tr>
      				<?php $i++; } while ($row_staf = mysql_fetch_assoc($staf)); ?>
                    <tr class="back_lightgrey">
                      <td colspan="7" align="right" valign="middle"><strong>Jumlah (RM)</strong></td>
                      <td align="right" valign="middle" nowrap="nowrap"><strong><?php echo number_format(getTotalKelabMSNTetap($d, $m, $y)+getTotalKelabMSNKontrak($d, $m, $y), 2) ?></strong></td>
                    </tr>
                  </table>
                </div>
                </li>
