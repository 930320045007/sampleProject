...
$sql_where = " (login.login_status = '1' OR (login.login_date_m >= '" . $m . "' && login.login_date_y >= '" . $y . "'))";
	...
	<div>
        ...
        <div class="tabbox">
        	<div class="profilemenu">
                ...
                <?php include('../inc/menu_senarai_fin.php');?>
          		<ul>
                <li class="line_b">
                <form id="form1" name="form1" method="get" action="salarylist.php">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td nowrap="nowrap" class="label noline">Bulan</td>
                    <td width="100%" class="noline">
                      <select name="dmy" id="dmy">
                      <?php for($i=(date('m')-5); $i<=(date('m')+2); $i++){?>
                        <option <?php if($i==$m) echo "selected=\"selected\"";?> value="<?php echo date('m/Y', mktime(0, 0, 0, $i, 1, date('Y')));?>"><?php echo date('M Y', mktime(0, 0, 0, $i, 1, date('Y')));?></option>
                        <?php }; ?>
                      </select>
                ...
                <li>
                <li>
                  <div class="note">Senarai gaji kakitangan bagi bulan <strong><?php echo date('M Y', mktime(0, 0, 0, $m, $d, $y));?></strong></div>
                </li>
                ...
                <div class="off2">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <th width="200" align="left" valign="middle" nowrap="nowrap">Cawangan<br /></th>
                      <th width="200" align="left" valign="middle" nowrap="nowrap">Bahagian</th>
                      <th align="center" valign="middle" nowrap="nowrap">No. KP</th>
                      <th align="center" valign="middle" nowrap="nowrap">Status</th>
                      <th align="center" valign="middle" nowrap="nowrap">Bank</th>
                      <th align="center" valign="middle" nowrap="nowrap">No. Akaun</th>
                      <th align="center" valign="middle" nowrap="nowrap">Gaji Kasar (RM)</th>
                      <th align="center" valign="middle" nowrap="nowrap">Pemotongan (RM)</th>
                      <th align="right" valign="middle" nowrap="nowrap">Gaji Bersih (RM)</th>
                    </tr>
                    ...
                    <tr class="on">
                      ...
                      <td align="left" valign="middle"><?php echo getDirSubName(getUserUnitIDByUserID($row_staf['user_stafid']));?></td>
                      <td align="left" valign="middle"><?php echo getDirSubName(getDirSubIDByUser($row_staf['user_stafid']));?></td>
                      ...
                      <td align="center" valign="middle" nowrap="nowrap"><?php echo getBankNameByUserID($row_staf['user_stafid']);?></td>
                      <td align="center" valign="middle" nowrap="nowrap"><?php echo getAccBankByUserID($row_staf['user_stafid']);?></td>
                      <td align="right" valign="middle" nowrap="nowrap"><?php echo number_format(getTotalSalaryByUserID($row_staf['user_stafid'], $d, $m, $y), 2);?></td>
                      <td align="right" valign="middle" nowrap="nowrap"><?php echo number_format(getTotalCutByUserID($row_staf['user_stafid'], $d, $m, $y), 2);?></td>
                      <td align="right" valign="middle" nowrap="nowrap"><?php echo number_format(getGajiBersihByUserID($row_staf['user_stafid'], $d, $m, $y), 2);?></td>
                    </tr>
