        ...
        <div class="tabbox">
        	<div class="profilemenu">
                ...
                <?php include('../inc/menu_senarai_fin.php');?>
          		<ul>
                <li class="line_b">
                <form id="form1" name="form1" method="get" action="reportlist.php">
                ...
                <div class="off2">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      (RM)</th>
                      <th align="center" valign="middle" nowrap="nowrap">JUMLAH POTONGAN <br />
                      (RM)</th>
                    </tr>
                    ...
                    <tr class="on">
                      ...
                      <td align="center" valign="middle" nowrap="nowrap"><?php echo number_format(getBasicSalaryByUserID($row_staf['user_stafid'], 0, $m, $y), 2);?></td>
                        ...
                        <td align="center" valign="middle" nowrap="nowrap"><?php echo number_format(getTransactionByUseriD($row_staf['user_stafid'], 58, 0, $m, $y), 2);?></td>
                        <td align="center" valign="middle" nowrap="nowrap"><?php echo number_format(getTotalTransactionCutByUserID($row_staf['user_stafid'], $m, $y),2); ?></td>
                    </tr>
