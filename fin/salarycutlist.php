...
mysql_select_db($database_hrmsdb, $hrmsdb);
$query_staf = "SELECT user_salary.*, transaction.transactiontype_id FROM www.user_salary LEFT JOIN www.transaction ON user_salary.transaction_id = transaction.transaction_id  LEFT JOIN www.user ON user.user_stafid = user_salary.user_stafid LEFT JOIN www.login ON login.user_stafid = user_salary.user_stafid WHERE (login.login_status = '1' OR (login.login_date_m >= '" . $m . "' && login.login_date_y >= '" . $y . "')) AND user_salary.usersalary_status = 1 AND user_salary.transaction_id = '" . $tt . "' AND ((user_salary.usersalary_date_m <= '" . $m . "' AND user_salary.usersalary_date_y = '" . $y . "')OR(user_salary.usersalary_date_m <= '" . $m . "' AND user_salary.usersalary_date_y < '" . $y . "')) AND (((user_salary.usersalary_end_m >= '" . $m . "' AND user_salary.usersalary_end_y = '" . $y . "') OR (user_salary.usersalary_end_m = 0 && user_salary.usersalary_end_y = 0))OR((user_salary.usersalary_end_y > '" . $y . "') OR (user_salary.usersalary_end_m = 0 && user_salary.usersalary_end_y = 0))) ORDER BY user.user_firstname ASC, user.user_lastname ASC";
        ...
        <div class="tabbox">
        	<div class="profilemenu">
                ...
                <?php include('../inc/menu_senarai_fin.php');?>
          		<ul>
                <li class="line_b">
                <form id="form1" name="form1" method="get" action="salarycutlist.php">
                ...
                <div>
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <th align="center" valign="middle" nowrap="nowrap">Tarikh Mula<br />
                      &amp; Tamat</th>
                      <th align="right" valign="middle" nowrap="nowrap">Potongan (RM)</th>
                    </tr>
                    ...
                    <tr class="on">
                      ...
                      <td align="center" valign="middle" nowrap="nowrap"><?php echo getTransactionDateStart($row_staf['user_stafid'], $tt);?><?php if(checkTransactionDateEnd($row_staf['user_stafid'], $tt)) echo "<br/>" . getTransactionDateEnd($row_staf['user_stafid'], $tt);?></td>
                    ...
                    <tr class="back_lightgrey">
                      ...
                      <td align="right" valign="middle" nowrap="nowrap"><strong><?php echo number_format(getTotalTransactionCut($tt, $d, $m, $y),2);?></strong></td>
                    </tr>
                  </table>
                </div>
                </li>
