            ...
            <ul>
                <li class="form_back">
                  <form id="form1" name="form1" method="get" action="report.php">
                    ...
                    <td><input name="button5" type="button" class="submitbutton" id="button5" value="Cetak" onclick="MM_openBrWindow('printreport.php?bil=<?php echo htmlspecialchars($_GET['bil'],ENT_QUOTES);?>','reportprint','status=yes,scrollbars=yes,width=800,height=600')" />
                      </td>
                      </tr>
                    </table>
                  </form>
