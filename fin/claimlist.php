             ...
             <?php if(checkUserSysAcc($row_user['user_stafid'], $menu, $menu2, 2)){?>
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
               <tr>
                  ...
                  <td><input name="button5" type="button" class="submitbutton" id="button5" value="Cetak" onclick="MM_openBrWindow('<?php echo $url_main;?>tadbir/printclaim.php?m=<?php echo $row_claim['claim_date_m'];?>&y=<?php echo $dy;?>','claimprint','status=yes,scrollbars=yes,width=800,height=600')" />
                  </td>      
              </tr>
              </table>
              </form>
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
               <?php if ($totalRows_claim > 0) { // Show if recordset not empty ?>
                ...
                <tr class="on">
                  ...
                  <td align="center" valign="middle"><?php echo getBasicSalaryByUserID($row_claim['user_stafid'],0,$row_claim['claim_on_m'],$dy); ?></td>
                 <td align="center" valign="middle" class="line_l line_r"><?php echo getRate1h($row_claim['user_stafid'],1, $row_claim['claim_on_m'], $dy); ?></td>
